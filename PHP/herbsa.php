...
{	 
	 $name = $_POST['name'];
	 $sql = "DELETE from h2 where hname='".$name."' ";
 ...
 <body class="body">
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo"<td class='t'>";echo  $row["hdisease"];echo"</td>";
                echo"<td>";echo  $row["hprice"];echo"</td>";
                echo"<td>";?> <img src="<?php echo $row["himage"];?>" height="250" width="300"> <?php echo"</td>";
                echo "<td>";
                ?>
                <form method='POST'>
                      <input type="hidden" name="name" value="<?php echo $row['hname']; ?>">
