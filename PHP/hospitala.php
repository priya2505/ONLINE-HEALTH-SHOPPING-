...
{	 
	 $name = $_POST['name'];
	 $sql = "DELETE from hop where hosname='".$name."' ";
    ...
    <body class="body">
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo"<td>";echo  $row["hosname"];echo"</td>";
                echo"<td class='t'>";echo  $row["hosdes"];echo"</td>";
                echo"<td class='t'>";echo  $row["hosadd"];echo"</td>";
                echo"<td>";echo  $row["hoscontact"];echo"</td>";
                echo"<td>";?> <img src="<?php echo $row["hosimage"];?>" height="250" width="300"> <?php echo"</td>";
                echo "<td>";
                ?>
                <form method='POST'>
                      <input type="hidden" name="name" value="<?php echo $row['hosname']; ?>">
